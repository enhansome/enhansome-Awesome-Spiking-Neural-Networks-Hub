...
* Integer-Valued Training and Spike-Driven Inference SNN for Object Detection (SpikeYOLO) (**ECCV 2024**). \[[paper](https://arxiv.org/abs/2407.20708)]\[[code](https://github.com/BICLab/SpikeYOLO) ⭐ 256 | 🐛 10 | 🌐 Python | 📅 2025-06-30]
...
| ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| **[SpikingJelly](https://github.com/fangwei123456/spikingjelly) ⭐ 2,119 \| 🐛 131 \| 🌐 Python \| 📅 2026-09-04**   | PyTorch full-stack SNN framework (data → train → deploy), fused CUDA neurons; de-facto platform — 2.0 line (Triton kernels, FlexSN) in dev since 2026-07 | [paper](https://www.science.org/doi/10.1126/sciadv.adi1480)                                           |
| **[snnTorch](https://github.com/jeshraghian/snntorch) ⭐ 2,040 \| 🐛 68 \| 🌐 Python \| 📅 2026-09-05**              | Spiking neurons as recurrent units in PyTorch; superb tutorials — 1.0.0 stable landed 2026-06                                                            | [paper](https://arxiv.org/abs/2109.12894)                                                             |
| **[Norse](https://github.com/norse/norse) ⭐ 818 \| 🐛 64 \| 🌐 Python \| 📅 2026-07-07**                            | Sparse, event-driven bio-inspired primitives in PyTorch                                                                                                  | —                                                                                                     |
| **[BindsNET](https://github.com/BindsNET/bindsnet) ⭐ 1,696 \| 🐛 15 \| 🌐 Python \| 📅 2026-09-06**                 | ML-oriented SNN simulation on PyTorch (STDP / RL)                                                                                                        | [paper](https://www.frontiersin.org/journals/neuroinformatics/articles/10.3389/fninf.2018.00089/full) |
...
| **[Brian2](https://github.com/brian-team/brian2) ⭐ 1,225 \| 🐛 207 \| 🌐 Python \| 📅 2026-09-03**                                                                                       | Equation-based simulator with runtime code generation                     | [paper](https://elifesciences.org/articles/47314)                           |
| **[NEST](https://github.com/nest/nest-simulator) ⭐ 664 \| 🐛 231 \| 🌐 C++ \| 📅 2026-09-03**                                                                                            | Large heterogeneous spiking point-neuron nets, laptop → supercomputer     | —                                                                           |
...
| **[Rockpool](https://github.com/synsense/rockpool) ⭐ 89 \| 🐛 4 \| 🌐 Python \| 📅 2026-07-03** / **[Sinabs](https://github.com/synsense/sinabs) ⭐ 123 \| 🐛 28 \| 🌐 Python \| 📅 2026-02-05** | SynSense libs to train & deploy onto DynapCNN / Speck                     | —                                                                                                                                                |
...
| **[BICLab/SpikeYOLO](https://github.com/BICLab/SpikeYOLO) ⭐ 256 \| 🐛 10 \| 🌐 Python \| 📅 2025-06-30**                                                                     | Integer-training + spike-driven detector (ECCV 2024)     |  \~250 |
...
| Repo                                                                                                                                             | What                                        | Stars |
| ------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------- | :---: |
| **[TheBrainLab/Awesome-Spiking-Neural-Networks](https://github.com/TheBrainLab/Awesome-Spiking-Neural-Networks) ⭐ 828 \| 🐛 3 \| 📅 2026-03-24** | Broad SNN paper list (papers, code, sites)  | \~805 |
...
| Repo                                                                                                                                | What                                                | Stars |
| ----------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------- | :---: |
| **[fzenke/spytorch](https://github.com/fzenke/spytorch) ⭐ 362 \| 🐛 3 \| 🌐 Jupyter Notebook \| 📅 2026-06-18**                     | The classic surrogate-gradient learning tutorial    | \~360 |
...
| **[SpiNNakerManchester/sPyNNaker](https://github.com/SpiNNakerManchester/sPyNNaker) ⭐ 120 \| 🐛 103 \| 🌐 Python \| 📅 2026-09-04** | PyNN on the million-core SpiNNaker machine          | \~117 |
...
* **Tian Yonghong (田永鸿)** — Peking University — neuromorphic vision, spike camera, SpikingJelly. \[[homepage](https://www.pkuml.org/staff/yhtian.html)]\[[scholar](https://scholar.google.com/citations?user=fn6hJx0AAAAJ)]\[[github](https://github.com/fangwei123456/spikingjelly) ⭐ 2,119 | 🐛 131 | 🌐 Python | 📅 2026-09-04]
...
* **Yu Zhaofei (余肇飞)** — Peking University — SNN learning, neural coding, SpikingJelly. \[[homepage](https://www.ai.pku.edu.cn/en/info/1459/2031.htm)]\[[scholar](https://scholar.google.com/citations?user=qaUgD50AAAAJ)]\[[github](https://github.com/fangwei123456/spikingjelly) ⭐ 2,119 | 🐛 131 | 🌐 Python | 📅 2026-09-04]
...
* **Jason Eshraghian** — UC Santa Cruz (Neuromorphic Computing Group) — snnTorch, spiking LLMs, memristive hardware. \[[homepage](https://ncg.ucsc.edu/)]\[[github](https://github.com/jeshraghian/snntorch) ⭐ 2,040 | 🐛 68 | 🌐 Python | 📅 2026-09-05]
...
* **Friedemann Zenke** — Friedrich Miescher Institute, Basel — surrogate-gradient learning, spiking network theory. \[[homepage](https://zenkelab.org/)]\[[scholar](https://scholar.google.com/citations?user=_IxvO8QAAAAJ)]\[[github](https://github.com/fzenke/spytorch) ⭐ 362 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-06-18]
...
* **Tobi Delbruck** — Institute of Neuroinformatics, UZH & ETH Zurich — event cameras (DVS), event-driven vision. \[[homepage](https://sensors.ini.ch/people/tobi-delbruck)]\[[github](https://github.com/SensorsINI/jaer) ⭐ 195 | 🐛 0 | 🌐 Java | 📅 2026-09-06]
