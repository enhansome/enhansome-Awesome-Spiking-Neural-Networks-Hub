...
* SpikingBrain: Spiking Brain-inspired Large Models (**TMLR 2026**) ★. \[[paper](https://arxiv.org/abs/2509.05276)]\[[code](https://github.com/BICLab/SpikingBrain-7B) ⭐ 1,377 | 🐛 9 | 🌐 Python | 📅 2026-05-14]
...
| ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| **[SpikingJelly](https://github.com/fangwei123456/spikingjelly) ⭐ 2,116 \| 🐛 129 \| 🌐 Python \| 📅 2026-09-03**   | PyTorch full-stack SNN framework (data → train → deploy), fused CUDA neurons; de-facto platform — 2.0 line (Triton kernels, FlexSN) in dev since 2026-07 | [paper](https://www.science.org/doi/10.1126/sciadv.adi1480)                                           |
| **[snnTorch](https://github.com/jeshraghian/snntorch) ⭐ 2,040 \| 🐛 76 \| 🌐 Python \| 📅 2026-08-30**              | Spiking neurons as recurrent units in PyTorch; superb tutorials — 1.0.0 stable landed 2026-06                                                            | [paper](https://arxiv.org/abs/2109.12894)                                                             |
| **[Norse](https://github.com/norse/norse) ⭐ 819 \| 🐛 64 \| 🌐 Python \| 📅 2026-07-07**                            | Sparse, event-driven bio-inspired primitives in PyTorch                                                                                                  | —                                                                                                     |
| **[BindsNET](https://github.com/BindsNET/bindsnet) ⭐ 1,695 \| 🐛 16 \| 🌐 Python \| 📅 2026-09-02**                 | ML-oriented SNN simulation on PyTorch (STDP / RL)                                                                                                        | [paper](https://www.frontiersin.org/journals/neuroinformatics/articles/10.3389/fninf.2018.00089/full) |
...
| **[Brian2](https://github.com/brian-team/brian2) ⭐ 1,224 \| 🐛 206 \| 🌐 Python \| 📅 2026-09-03**                                                                                       | Equation-based simulator with runtime code generation                     | [paper](https://elifesciences.org/articles/47314)                           |
...
| Repo                                                                                                                                                                         | What                                                     |  Stars |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- | :----: |
| **[BICLab/SpikingBrain-7B](https://github.com/BICLab/SpikingBrain-7B) ⭐ 1,377 \| 🐛 9 \| 🌐 Python \| 📅 2026-05-14**                                                        | Spiking brain-inspired 7B LLM (CAS, 2025)                | \~1.3k |
...
| **[SpiNNakerManchester/sPyNNaker](https://github.com/SpiNNakerManchester/sPyNNaker) ⭐ 120 \| 🐛 103 \| 🌐 Python \| 📅 2026-09-03** | PyNN on the million-core SpiNNaker machine          | \~117 |
...
* **Tian Yonghong (田永鸿)** — Peking University — neuromorphic vision, spike camera, SpikingJelly. \[[homepage](https://www.pkuml.org/staff/yhtian.html)]\[[scholar](https://scholar.google.com/citations?user=fn6hJx0AAAAJ)]\[[github](https://github.com/fangwei123456/spikingjelly) ⭐ 2,116 | 🐛 129 | 🌐 Python | 📅 2026-09-03]
...
* **Yu Zhaofei (余肇飞)** — Peking University — SNN learning, neural coding, SpikingJelly. \[[homepage](https://www.ai.pku.edu.cn/en/info/1459/2031.htm)]\[[scholar](https://scholar.google.com/citations?user=qaUgD50AAAAJ)]\[[github](https://github.com/fangwei123456/spikingjelly) ⭐ 2,116 | 🐛 129 | 🌐 Python | 📅 2026-09-03]
...
* **Jason Eshraghian** — UC Santa Cruz (Neuromorphic Computing Group) — snnTorch, spiking LLMs, memristive hardware. \[[homepage](https://ncg.ucsc.edu/)]\[[github](https://github.com/jeshraghian/snntorch) ⭐ 2,040 | 🐛 76 | 🌐 Python | 📅 2026-08-30]
...
* **Tobi Delbruck** — Institute of Neuroinformatics, UZH & ETH Zurich — event cameras (DVS), event-driven vision. \[[homepage](https://sensors.ini.ch/people/tobi-delbruck)]\[[github](https://github.com/SensorsINI/jaer) ⭐ 193 | 🐛 0 | 🌐 Java | 📅 2026-09-02]
