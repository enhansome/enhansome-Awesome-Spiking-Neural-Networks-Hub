...
* DYNAP-CNN & Speck: Event-Driven Convolutional Neuromorphic Vision Processors (SynSense) (**2020**). \[[paper](https://www.synsense.ai/products/speck-2/)]\[[code](https://github.com/synsense/sinabs) ⭐ 125 | 🐛 27 | 🌐 Python | 📅 2026-02-05]
...
| Suite          | What                                                                             | Links                                                                                                                                    |
| -------------- | -------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| **NeuroBench** | Standardized tasks & metrics to fairly benchmark neuromorphic algorithms/systems | [paper](https://arxiv.org/abs/2304.04640) · [code](https://github.com/NeuroBench/neurobench) ⭐ 134 \| 🐛 9 \| 🌐 Python \| 📅 2026-05-14 |
...
| ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| **[SpikingJelly](https://github.com/fangwei123456/spikingjelly) ⭐ 2,134 \| 🐛 125 \| 🌐 Python \| 📅 2026-09-14**   | PyTorch full-stack SNN framework (data → train → deploy), fused CUDA neurons; de-facto platform — 2.0 line (Triton kernels, FlexSN) in dev since 2026-07 | [paper](https://www.science.org/doi/10.1126/sciadv.adi1480)                                           |
| **[snnTorch](https://github.com/jeshraghian/snntorch) ⭐ 2,046 \| 🐛 58 \| 🌐 Python \| 📅 2026-09-14**              | Spiking neurons as recurrent units in PyTorch; superb tutorials — 1.0.0 stable landed 2026-06                                                            | [paper](https://arxiv.org/abs/2109.12894)                                                             |
| **[Norse](https://github.com/norse/norse) ⭐ 819 \| 🐛 64 \| 🌐 Python \| 📅 2026-07-07**                            | Sparse, event-driven bio-inspired primitives in PyTorch                                                                                                  | —                                                                                                     |
| **[BindsNET](https://github.com/BindsNET/bindsnet) ⭐ 1,700 \| 🐛 9 \| 🌐 Python \| 📅 2026-09-16**                  | ML-oriented SNN simulation on PyTorch (STDP / RL)                                                                                                        | [paper](https://www.frontiersin.org/journals/neuroinformatics/articles/10.3389/fninf.2018.00089/full) |
...
| **[Brian2](https://github.com/brian-team/brian2) ⭐ 1,230 \| 🐛 208 \| 🌐 Python \| 📅 2026-09-14**                                                                                       | Equation-based simulator with runtime code generation                     | [paper](https://elifesciences.org/articles/47314)                           |
| **[NEST](https://github.com/nest/nest-simulator) ⭐ 667 \| 🐛 224 \| 🌐 C++ \| 📅 2026-09-15**                                                                                            | Large heterogeneous spiking point-neuron nets, laptop → supercomputer     | —                                                                           |
...
| **[BrainPy](https://github.com/brainpy/BrainPy) ⭐ 710 \| 🐛 4 \| 🌐 Python \| 📅 2026-08-13**                                                                                            | JAX brain-dynamics programming (spiking / rate / ODE-SDE)                 | [paper](https://elifesciences.org/articles/86365)                           |
| **[BrainCog](https://github.com/BrainCog-X/Brain-Cog) ⭐ 649 \| 🐛 30 \| 🌐 Python \| 📅 2025-11-06**                                                                                     | SNN brain-inspired cognitive-intelligence engine (CAS)                    | [paper](https://arxiv.org/abs/2207.08533)                                   |
...
| **[Rockpool](https://github.com/synsense/rockpool) ⭐ 91 \| 🐛 3 \| 🌐 Python \| 📅 2026-07-03** / **[Sinabs](https://github.com/synsense/sinabs) ⭐ 125 \| 🐛 27 \| 🌐 Python \| 📅 2026-02-05** | SynSense libs to train & deploy onto DynapCNN / Speck                     | —                                                                                                                                                |
...
| Repo                                                                                                                                             | What                                        | Stars |
| ------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------- | :---: |
| **[TheBrainLab/Awesome-Spiking-Neural-Networks](https://github.com/TheBrainLab/Awesome-Spiking-Neural-Networks) ⭐ 833 \| 🐛 4 \| 📅 2026-03-24** | Broad SNN paper list (papers, code, sites)  | \~805 |
| **[AXYZdong/awesome-snn-conference-paper](https://github.com/AXYZdong/awesome-snn-conference-paper) ⭐ 467 \| 🐛 1 \| 🌐 HTML \| 📅 2026-05-04**  | Top-conf/journal SNN papers + code, by year | \~460 |
...
| Repo                                                                                                                                | What                                                | Stars |
| ----------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------- | :---: |
| **[fzenke/spytorch](https://github.com/fzenke/spytorch) ⭐ 364 \| 🐛 3 \| 🌐 Jupyter Notebook \| 📅 2026-06-18**                     | The classic surrogate-gradient learning tutorial    | \~360 |
| **[open-neuromorphic/open-neuromorphic](https://github.com/open-neuromorphic/open-neuromorphic) ⭐ 327 \| 🐛 6 \| 📅 2025-07-12**    | Global community hub for the neuromorphic ecosystem | \~315 |
...
| **[SpiNNakerManchester/sPyNNaker](https://github.com/SpiNNakerManchester/sPyNNaker) ⭐ 120 \| 🐛 103 \| 🌐 Python \| 📅 2026-09-14** | PyNN on the million-core SpiNNaker machine          | \~117 |
...
* **Tian Yonghong (田永鸿)** — Peking University — neuromorphic vision, spike camera, SpikingJelly. \[[homepage](https://www.pkuml.org/staff/yhtian.html)]\[[scholar](https://scholar.google.com/citations?user=fn6hJx0AAAAJ)]\[[github](https://github.com/fangwei123456/spikingjelly) ⭐ 2,134 | 🐛 125 | 🌐 Python | 📅 2026-09-14]
...
* **Yu Zhaofei (余肇飞)** — Peking University — SNN learning, neural coding, SpikingJelly. \[[homepage](https://www.ai.pku.edu.cn/en/info/1459/2031.htm)]\[[scholar](https://scholar.google.com/citations?user=qaUgD50AAAAJ)]\[[github](https://github.com/fangwei123456/spikingjelly) ⭐ 2,134 | 🐛 125 | 🌐 Python | 📅 2026-09-14]
...
* **Zeng Yi (曾毅)** — Institute of Automation, CAS (CASIA) — brain-inspired cognitive intelligence, brain simulation, AI ethics. \[[homepage](https://www.brain-cog.network/)]\[[github](https://github.com/BrainCog-X/Brain-Cog) ⭐ 649 | 🐛 30 | 🌐 Python | 📅 2025-11-06]
...
* **Jason Eshraghian** — UC Santa Cruz (Neuromorphic Computing Group) — snnTorch, spiking LLMs, memristive hardware. \[[homepage](https://ncg.ucsc.edu/)]\[[github](https://github.com/jeshraghian/snntorch) ⭐ 2,046 | 🐛 58 | 🌐 Python | 📅 2026-09-14]
...
* **Friedemann Zenke** — Friedrich Miescher Institute, Basel — surrogate-gradient learning, spiking network theory. \[[homepage](https://zenkelab.org/)]\[[scholar](https://scholar.google.com/citations?user=_IxvO8QAAAAJ)]\[[github](https://github.com/fzenke/spytorch) ⭐ 364 | 🐛 3 | 🌐 Jupyter Notebook | 📅 2026-06-18]
...
* **Tobi Delbruck** — Institute of Neuroinformatics, UZH & ETH Zurich — event cameras (DVS), event-driven vision. \[[homepage](https://sensors.ini.ch/people/tobi-delbruck)]\[[github](https://github.com/SensorsINI/jaer) ⭐ 201 | 🐛 1 | 🌐 Java | 📅 2026-09-16]
