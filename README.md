...
* SpikingBrain: Spiking Brain-inspired Large Models (**TMLR 2026**) ★. \[[paper](https://arxiv.org/abs/2509.05276)]\[[code](https://github.com/BICLab/SpikingBrain-7B) ⭐ 1,363 | 🐛 9 | 🌐 Python | 📅 2026-05-14]
...
* DYNAP-CNN & Speck: Event-Driven Convolutional Neuromorphic Vision Processors (SynSense) (**2020**). \[[paper](https://www.synsense.ai/products/speck-2/)]\[[code](https://github.com/synsense/sinabs) ⭐ 120 | 🐛 27 | 🌐 Python | 📅 2026-02-05]
...
| ------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| **[SpikingJelly](https://github.com/fangwei123456/spikingjelly) ⭐ 2,102 \| 🐛 126 \| 🌐 Python \| 📅 2026-08-13**   | PyTorch full-stack SNN framework (data → train → deploy), fused CUDA neurons; de-facto platform | [paper](https://www.science.org/doi/10.1126/sciadv.adi1480)                                           |
...
| **[Norse](https://github.com/norse/norse) ⭐ 816 \| 🐛 64 \| 🌐 Python \| 📅 2026-07-07**                            | Sparse, event-driven bio-inspired primitives in PyTorch                                         | —                                                                                                     |
| **[BindsNET](https://github.com/BindsNET/bindsnet) ⭐ 1,694 \| 🐛 15 \| 🌐 Python \| 📅 2026-08-09**                 | ML-oriented SNN simulation on PyTorch (STDP / RL)                                               | [paper](https://www.frontiersin.org/journals/neuroinformatics/articles/10.3389/fninf.2018.00089/full) |
...
| **[Rockpool](https://github.com/synsense/rockpool) ⭐ 89 \| 🐛 4 \| 🌐 Python \| 📅 2026-07-03** / **[Sinabs](https://github.com/synsense/sinabs) ⭐ 120 \| 🐛 27 \| 🌐 Python \| 📅 2026-02-05** | SynSense libs to train & deploy onto DynapCNN / Speck                     | —                                                                                                                                                |
...
| Repo                                                                                                                                                                         | What                                                     |  Stars |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- | :----: |
| **[BICLab/SpikingBrain-7B](https://github.com/BICLab/SpikingBrain-7B) ⭐ 1,363 \| 🐛 9 \| 🌐 Python \| 📅 2026-05-14**                                                        | Spiking brain-inspired 7B LLM (CAS, 2025)                | \~1.3k |
...
* **Tian Yonghong (田永鸿)** — Peking University — neuromorphic vision, spike camera, SpikingJelly. \[[homepage](https://www.pkuml.org/staff/yhtian.html)]\[[scholar](https://scholar.google.com/citations?user=fn6hJx0AAAAJ)]\[[github](https://github.com/fangwei123456/spikingjelly) ⭐ 2,102 | 🐛 126 | 🌐 Python | 📅 2026-08-13]
...
* **Yu Zhaofei (余肇飞)** — Peking University — SNN learning, neural coding, SpikingJelly. \[[homepage](https://www.ai.pku.edu.cn/en/info/1459/2031.htm)]\[[scholar](https://scholar.google.com/citations?user=qaUgD50AAAAJ)]\[[github](https://github.com/fangwei123456/spikingjelly) ⭐ 2,102 | 🐛 126 | 🌐 Python | 📅 2026-08-13]
...
* **Tobi Delbruck** — Institute of Neuroinformatics, UZH & ETH Zurich — event cameras (DVS), event-driven vision. \[[homepage](https://sensors.ini.ch/people/tobi-delbruck)]\[[github](https://github.com/SensorsINI/jaer) ⭐ 191 | 🐛 0 | 🌐 Java | 📅 2026-08-15]
