...
* SpikingBrain: Spiking Brain-inspired Large Models (**TMLR 2026**) ★. \[[paper](https://arxiv.org/abs/2509.05276)]\[[code](https://github.com/BICLab/SpikingBrain-7B) ⭐ 1,380 | 🐛 9 | 🌐 Python | 📅 2026-05-14]
...
| ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| **[SpikingJelly](https://github.com/fangwei123456/spikingjelly) ⭐ 2,135 \| 🐛 126 \| 🌐 Python \| 📅 2026-09-14**   | PyTorch full-stack SNN framework (data → train → deploy), fused CUDA neurons; de-facto platform — 2.0 line (Triton kernels, FlexSN) in dev since 2026-07 | [paper](https://www.science.org/doi/10.1126/sciadv.adi1480)                                           |
...
| **[ANNarchy](https://github.com/ANNarchy/ANNarchy) ⭐ 46 \| 🐛 6 \| 🌐 Python \| 📅 2026-09-16**                     | Code-generation simulator (rate + spiking) → C++/CUDA                                                                                                    | —                                                                                                     |
...
| **[Brian2](https://github.com/brian-team/brian2) ⭐ 1,231 \| 🐛 208 \| 🌐 Python \| 📅 2026-09-14**                                                                                       | Equation-based simulator with runtime code generation                     | [paper](https://elifesciences.org/articles/47314)                           |
| **[NEST](https://github.com/nest/nest-simulator) ⭐ 668 \| 🐛 224 \| 🌐 C++ \| 📅 2026-09-15**                                                                                            | Large heterogeneous spiking point-neuron nets, laptop → supercomputer     | —                                                                           |
| **[GeNN](https://github.com/genn-team/genn) ⭐ 280 \| 🐛 45 \| 🌐 C++ \| 📅 2026-08-24**                                                                                                  | GPU code-generation SNN simulator (CUDA / HIP)                            | [paper](https://www.nature.com/articles/srep18854)                          |
...
| **[BrainCog](https://github.com/BrainCog-X/Brain-Cog) ⭐ 650 \| 🐛 30 \| 🌐 Python \| 📅 2025-11-06**                                                                                     | SNN brain-inspired cognitive-intelligence engine (CAS)                    | [paper](https://arxiv.org/abs/2207.08533)                                   |
...
| Repo                                                                                                                                                                         | What                                                     |  Stars |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- | :----: |
| **[BICLab/SpikingBrain-7B](https://github.com/BICLab/SpikingBrain-7B) ⭐ 1,380 \| 🐛 9 \| 🌐 Python \| 📅 2026-05-14**                                                        | Spiking brain-inspired 7B LLM (CAS, 2025)                | \~1.3k |
...
| **[open-neuromorphic/open-neuromorphic](https://github.com/open-neuromorphic/open-neuromorphic) ⭐ 329 \| 🐛 6 \| 📅 2025-07-12**    | Global community hub for the neuromorphic ecosystem | \~315 |
...
* **Tian Yonghong (田永鸿)** — Peking University — neuromorphic vision, spike camera, SpikingJelly. \[[homepage](https://www.pkuml.org/staff/yhtian.html)]\[[scholar](https://scholar.google.com/citations?user=fn6hJx0AAAAJ)]\[[github](https://github.com/fangwei123456/spikingjelly) ⭐ 2,135 | 🐛 126 | 🌐 Python | 📅 2026-09-14]
...
* **Yu Zhaofei (余肇飞)** — Peking University — SNN learning, neural coding, SpikingJelly. \[[homepage](https://www.ai.pku.edu.cn/en/info/1459/2031.htm)]\[[scholar](https://scholar.google.com/citations?user=qaUgD50AAAAJ)]\[[github](https://github.com/fangwei123456/spikingjelly) ⭐ 2,135 | 🐛 126 | 🌐 Python | 📅 2026-09-14]
...
* **Zeng Yi (曾毅)** — Institute of Automation, CAS (CASIA) — brain-inspired cognitive intelligence, brain simulation, AI ethics. \[[homepage](https://www.brain-cog.network/)]\[[github](https://github.com/BrainCog-X/Brain-Cog) ⭐ 650 | 🐛 30 | 🌐 Python | 📅 2025-11-06]
...
* **Tobi Delbruck** — Institute of Neuroinformatics, UZH & ETH Zurich — event cameras (DVS), event-driven vision. \[[homepage](https://sensors.ini.ch/people/tobi-delbruck)]\[[github](https://github.com/SensorsINI/jaer) ⭐ 202 | 🐛 1 | 🌐 Java | 📅 2026-09-17]
