...
* SpikingBrain: Spiking Brain-inspired Large Models (**TMLR 2026**) ★. \[[paper](https://arxiv.org/abs/2509.05276)]\[[code](https://github.com/BICLab/SpikingBrain-7B) ⭐ 1,383 | 🐛 10 | 🌐 Python | 📅 2026-05-14]
...
* SpikingBrain2.0: Brain-Inspired Foundation Models for Efficient Long-Context and Cross-Platform Inference (**arXiv 2026**). \[[paper](https://arxiv.org/abs/2604.22575)]\[[code](https://github.com/BICLab/SpikingBrain2.0) ⭐ 57 | 🐛 5 | 🌐 Python | 📅 2026-04-27]
...
| ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| **[SpikingJelly](https://github.com/fangwei123456/spikingjelly) ⭐ 2,140 \| 🐛 125 \| 🌐 Python \| 📅 2026-09-26**   | PyTorch full-stack SNN framework (data → train → deploy), fused CUDA neurons; de-facto platform — 2.0 line (Triton kernels, FlexSN) in dev since 2026-07 | [paper](https://www.science.org/doi/10.1126/sciadv.adi1480)                                           |
...
| **[Brian2](https://github.com/brian-team/brian2) ⭐ 1,239 \| 🐛 208 \| 🌐 Python \| 📅 2026-09-21**                                                                                       | Equation-based simulator with runtime code generation                     | [paper](https://elifesciences.org/articles/47314)                           |
...
| **[BrainPy](https://github.com/brainpy/BrainPy) ⭐ 713 \| 🐛 4 \| 🌐 Python \| 📅 2026-08-13**                                                                                            | JAX brain-dynamics programming (spiking / rate / ODE-SDE)                 | [paper](https://elifesciences.org/articles/86365)                           |
...
| **[PyNN](https://github.com/NeuralEnsemble/PyNN) ⭐ 313 \| 🐛 118 \| 🌐 Python \| 📅 2026-09-10**                                                                                         | Simulator-independent Python API (NEST / NEURON / Brian / SpiNNaker)      | [paper](https://doi.org/10.3389/neuro.11.011.2008)                          |
...
| Repo                                                                                                                                                                         | What                                                     |  Stars |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- | :----: |
| **[BICLab/SpikingBrain-7B](https://github.com/BICLab/SpikingBrain-7B) ⭐ 1,383 \| 🐛 10 \| 🌐 Python \| 📅 2026-05-14**                                                       | Spiking brain-inspired 7B LLM (CAS, 2025)                | \~1.3k |
...
| **[open-neuromorphic/open-neuromorphic](https://github.com/open-neuromorphic/open-neuromorphic) ⭐ 330 \| 🐛 8 \| 📅 2025-07-12**    | Global community hub for the neuromorphic ecosystem | \~315 |
...
* **Tian Yonghong (田永鸿)** — Peking University — neuromorphic vision, spike camera, SpikingJelly. \[[homepage](https://www.pkuml.org/staff/yhtian.html)]\[[scholar](https://scholar.google.com/citations?user=fn6hJx0AAAAJ)]\[[github](https://github.com/fangwei123456/spikingjelly) ⭐ 2,140 | 🐛 125 | 🌐 Python | 📅 2026-09-26]
...
* **Yu Zhaofei (余肇飞)** — Peking University — SNN learning, neural coding, SpikingJelly. \[[homepage](https://www.ai.pku.edu.cn/en/info/1459/2031.htm)]\[[scholar](https://scholar.google.com/citations?user=qaUgD50AAAAJ)]\[[github](https://github.com/fangwei123456/spikingjelly) ⭐ 2,140 | 🐛 125 | 🌐 Python | 📅 2026-09-26]
...
* **Tobi Delbruck** — Institute of Neuroinformatics, UZH & ETH Zurich — event cameras (DVS), event-driven vision. \[[homepage](https://sensors.ini.ch/people/tobi-delbruck)]\[[github](https://github.com/SensorsINI/jaer) ⭐ 201 | 🐛 0 | 🌐 Java | 📅 2026-09-26]
