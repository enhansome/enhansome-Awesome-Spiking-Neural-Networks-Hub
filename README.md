...
* Deep Residual Learning in Spiking Neural Networks (SEW-ResNet) (**NeurIPS 2021**) ★. \[[paper](https://arxiv.org/abs/2102.04159)]\[[code](https://github.com/fangwei123456/Spike-Element-Wise-ResNet) ⭐ 196 | 🐛 12 | 🌐 Python | 📅 2022-08-09]
...
* Spike-driven Transformer V2 (Meta-SpikeFormer) (**ICLR 2024**). \[[paper](https://arxiv.org/abs/2404.03663)]\[[code](https://github.com/BICLab/Spike-Driven-Transformer-V2) ⭐ 230 | 🐛 1 | 🌐 Python | 📅 2024-05-10]
...
* DYNAP-CNN & Speck: Event-Driven Convolutional Neuromorphic Vision Processors (SynSense) (**2020**). \[[paper](https://www.synsense.ai/products/speck-2/)]\[[code](https://github.com/synsense/sinabs) ⭐ 118 | 🐛 27 | 🌐 Python | 📅 2026-02-05]
...
| ------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| **[SpikingJelly](https://github.com/fangwei123456/spikingjelly) ⭐ 2,098 \| 🐛 126 \| 🌐 Python \| 📅 2026-08-13**   | PyTorch full-stack SNN framework (data → train → deploy), fused CUDA neurons; de-facto platform | [paper](https://www.science.org/doi/10.1126/sciadv.adi1480)                                           |
...
| **[BindsNET](https://github.com/BindsNET/bindsnet) ⭐ 1,692 \| 🐛 15 \| 🌐 Python \| 📅 2026-08-09**                 | ML-oriented SNN simulation on PyTorch (STDP / RL)                                               | [paper](https://www.frontiersin.org/journals/neuroinformatics/articles/10.3389/fninf.2018.00089/full) |
...
| **[Brian2](https://github.com/brian-team/brian2) ⭐ 1,213 \| 🐛 205 \| 🌐 Python \| 📅 2026-08-01**                                                                                       | Equation-based simulator with runtime code generation                     | [paper](https://elifesciences.org/articles/47314)                           |
| **[NEST](https://github.com/nest/nest-simulator) ⭐ 657 \| 🐛 227 \| 🌐 C++ \| 📅 2026-08-10**                                                                                            | Large heterogeneous spiking point-neuron nets, laptop → supercomputer     | —                                                                           |
| **[GeNN](https://github.com/genn-team/genn) ⭐ 279 \| 🐛 44 \| 🌐 C++ \| 📅 2026-07-01**                                                                                                  | GPU code-generation SNN simulator (CUDA / HIP)                            | [paper](https://www.nature.com/articles/srep18854)                          |
...
| **[PyNN](https://github.com/NeuralEnsemble/PyNN) ⭐ 309 \| 🐛 118 \| 🌐 Python \| 📅 2026-07-08**                                                                                         | Simulator-independent Python API (NEST / NEURON / Brian / SpiNNaker)      | [paper](https://doi.org/10.3389/neuro.11.011.2008)                          |
...
| **[Rockpool](https://github.com/synsense/rockpool) ⭐ 88 \| 🐛 4 \| 🌐 Python \| 📅 2026-07-03** / **[Sinabs](https://github.com/synsense/sinabs) ⭐ 118 \| 🐛 27 \| 🌐 Python \| 📅 2026-02-05** | SynSense libs to train & deploy onto DynapCNN / Speck                     | —                                                                                                                                                |
...
| **[BICLab/Spike-Driven-Transformer-V2](https://github.com/BICLab/Spike-Driven-Transformer-V2) ⭐ 230 \| 🐛 1 \| 🌐 Python \| 📅 2024-05-10**                                  | Meta-SpikeFormer (ICLR 2024)                             |  \~230 |
...
| **[fangwei123456/Spike-Element-Wise-ResNet](https://github.com/fangwei123456/Spike-Element-Wise-ResNet) ⭐ 196 \| 🐛 12 \| 🌐 Python \| 📅 2022-08-09**                       | SEW-ResNet (NeurIPS 2021)                                |  \~195 |
...
| Repo                                                                                                                                             | What                                        | Stars |
| ------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------- | :---: |
| **[TheBrainLab/Awesome-Spiking-Neural-Networks](https://github.com/TheBrainLab/Awesome-Spiking-Neural-Networks) ⭐ 815 \| 🐛 3 \| 📅 2026-03-24** | Broad SNN paper list (papers, code, sites)  | \~805 |
...
| **[SpiNNakerManchester/sPyNNaker](https://github.com/SpiNNakerManchester/sPyNNaker) ⭐ 117 \| 🐛 101 \| 🌐 Python \| 📅 2026-08-11** | PyNN on the million-core SpiNNaker machine          | \~117 |
...
* **Tian Yonghong (田永鸿)** — Peking University — neuromorphic vision, spike camera, SpikingJelly. \[[homepage](https://www.pkuml.org/staff/yhtian.html)]\[[scholar](https://scholar.google.com/citations?user=fn6hJx0AAAAJ)]\[[github](https://github.com/fangwei123456/spikingjelly) ⭐ 2,098 | 🐛 126 | 🌐 Python | 📅 2026-08-13]
...
* **Yu Zhaofei (余肇飞)** — Peking University — SNN learning, neural coding, SpikingJelly. \[[homepage](https://www.ai.pku.edu.cn/en/info/1459/2031.htm)]\[[scholar](https://scholar.google.com/citations?user=qaUgD50AAAAJ)]\[[github](https://github.com/fangwei123456/spikingjelly) ⭐ 2,098 | 🐛 126 | 🌐 Python | 📅 2026-08-13]
...
* **Thomas Nowotny** — University of Sussex — GPU-accelerated SNN simulation. \[[homepage](https://profiles.sussex.ac.uk/p206151-thomas-nowotny)]\[[github](https://github.com/genn-team/genn) ⭐ 279 | 🐛 44 | 🌐 C++ | 📅 2026-07-01]
...
* **Tobi Delbruck** — Institute of Neuroinformatics, UZH & ETH Zurich — event cameras (DVS), event-driven vision. \[[homepage](https://sensors.ini.ch/people/tobi-delbruck)]\[[github](https://github.com/SensorsINI/jaer) ⭐ 191 | 🐛 0 | 🌐 Java | 📅 2026-08-13]
