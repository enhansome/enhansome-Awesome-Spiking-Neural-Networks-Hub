...
* SpikingBrain: Spiking Brain-inspired Large Models (**TMLR 2026**) ★. \[[paper](https://arxiv.org/abs/2509.05276)]\[[code](https://github.com/BICLab/SpikingBrain-7B) ⭐ 1,382 | 🐛 10 | 🌐 Python | 📅 2026-05-14]
...
* SpikingBrain2.0: Brain-Inspired Foundation Models for Efficient Long-Context and Cross-Platform Inference (**arXiv 2026**). \[[paper](https://arxiv.org/abs/2604.22575)]\[[code](https://github.com/BICLab/SpikingBrain2.0) ⭐ 56 | 🐛 5 | 🌐 Python | 📅 2026-04-27]
...
| Suite          | What                                                                             | Links                                                                                                                                     |
| -------------- | -------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| **NeuroBench** | Standardized tasks & metrics to fairly benchmark neuromorphic algorithms/systems | [paper](https://arxiv.org/abs/2304.04640) · [code](https://github.com/NeuroBench/neurobench) ⭐ 139 \| 🐛 10 \| 🌐 Python \| 📅 2026-05-14 |
...
| ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| **[SpikingJelly](https://github.com/fangwei123456/spikingjelly) ⭐ 2,141 \| 🐛 126 \| 🌐 Python \| 📅 2026-09-25**   | PyTorch full-stack SNN framework (data → train → deploy), fused CUDA neurons; de-facto platform — 2.0 line (Triton kernels, FlexSN) in dev since 2026-07 | [paper](https://www.science.org/doi/10.1126/sciadv.adi1480)                                           |
| **[snnTorch](https://github.com/jeshraghian/snntorch) ⭐ 2,057 \| 🐛 61 \| 🌐 Python \| 📅 2026-09-25**              | Spiking neurons as recurrent units in PyTorch; superb tutorials — 1.0.0 stable landed 2026-06                                                            | [paper](https://arxiv.org/abs/2109.12894)                                                             |
| **[Norse](https://github.com/norse/norse) ⭐ 823 \| 🐛 69 \| 🌐 Python \| 📅 2026-07-07**                            | Sparse, event-driven bio-inspired primitives in PyTorch                                                                                                  | —                                                                                                     |
| **[BindsNET](https://github.com/BindsNET/bindsnet) ⭐ 1,703 \| 🐛 10 \| 🌐 Python \| 📅 2026-09-22**                 | ML-oriented SNN simulation on PyTorch (STDP / RL)                                                                                                        | [paper](https://www.frontiersin.org/journals/neuroinformatics/articles/10.3389/fninf.2018.00089/full) |
...
| Library                                                                                                                                                                                  | What it's for                                                             | Links                                                                       |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- | --------------------------------------------------------------------------- |
| **[Nengo](https://github.com/nengo/nengo) ⭐ 949 \| 🐛 140 \| 🌐 Python \| 📅 2026-08-02** / **[NengoDL](https://github.com/nengo/nengo-dl) ⭐ 94 \| 🐛 32 \| 🌐 Python \| 📅 2026-08-02** | Large-scale functional brain models (NEF); backend-agnostic, TF-trainable | [paper](https://www.frontiersin.org/articles/10.3389/fninf.2013.00048/full) |
...
| **[NEST](https://github.com/nest/nest-simulator) ⭐ 670 \| 🐛 224 \| 🌐 C++ \| 📅 2026-09-18**                                                                                            | Large heterogeneous spiking point-neuron nets, laptop → supercomputer     | —                                                                           |
...
| **[v2e](https://github.com/SensorsINI/v2e) ⭐ 489 \| 🐛 23 \| 🌐 Python \| 📅 2026-04-13**                                                                                                       | Video frames → realistic DVS events (no camera needed)                    | [paper](https://openaccess.thecvf.com/content/CVPR2021W/EventVision/html/Hu_v2e_From_Video_Frames_to_Realistic_DVS_Events_CVPRW_2021_paper.html) |
...
| Repo                                                                                                                                                                         | What                                                     |  Stars |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------- | :----: |
| **[BICLab/SpikingBrain-7B](https://github.com/BICLab/SpikingBrain-7B) ⭐ 1,382 \| 🐛 10 \| 🌐 Python \| 📅 2026-05-14**                                                       | Spiking brain-inspired 7B LLM (CAS, 2025)                | \~1.3k |
...
| Repo                                                                                                                                             | What                                        | Stars |
| ------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------- | :---: |
| **[TheBrainLab/Awesome-Spiking-Neural-Networks](https://github.com/TheBrainLab/Awesome-Spiking-Neural-Networks) ⭐ 841 \| 🐛 4 \| 📅 2026-03-24** | Broad SNN paper list (papers, code, sites)  | \~805 |
...
| **[prophesee-ai/openeb](https://github.com/prophesee-ai/openeb) ⭐ 305 \| 🐛 25 \| 🌐 C++ \| 📅 2026-05-15**                         | Open SDK for event-based vision hardware            | \~295 |
| **[SpiNNakerManchester/sPyNNaker](https://github.com/SpiNNakerManchester/sPyNNaker) ⭐ 120 \| 🐛 103 \| 🌐 Python \| 📅 2026-09-25** | PyNN on the million-core SpiNNaker machine          | \~117 |
...
* **Tian Yonghong (田永鸿)** — Peking University — neuromorphic vision, spike camera, SpikingJelly. \[[homepage](https://www.pkuml.org/staff/yhtian.html)]\[[scholar](https://scholar.google.com/citations?user=fn6hJx0AAAAJ)]\[[github](https://github.com/fangwei123456/spikingjelly) ⭐ 2,141 | 🐛 126 | 🌐 Python | 📅 2026-09-25]
...
* **Yu Zhaofei (余肇飞)** — Peking University — SNN learning, neural coding, SpikingJelly. \[[homepage](https://www.ai.pku.edu.cn/en/info/1459/2031.htm)]\[[scholar](https://scholar.google.com/citations?user=qaUgD50AAAAJ)]\[[github](https://github.com/fangwei123456/spikingjelly) ⭐ 2,141 | 🐛 126 | 🌐 Python | 📅 2026-09-25]
...
* **Jason Eshraghian** — UC Santa Cruz (Neuromorphic Computing Group) — snnTorch, spiking LLMs, memristive hardware. \[[homepage](https://ncg.ucsc.edu/)]\[[github](https://github.com/jeshraghian/snntorch) ⭐ 2,057 | 🐛 61 | 🌐 Python | 📅 2026-09-25]
...
* **Tobi Delbruck** — Institute of Neuroinformatics, UZH & ETH Zurich — event cameras (DVS), event-driven vision. \[[homepage](https://sensors.ini.ch/people/tobi-delbruck)]\[[github](https://github.com/SensorsINI/jaer) ⭐ 202 | 🐛 0 | 🌐 Java | 📅 2026-09-25]
