...
* Spike-driven Transformer (**NeurIPS 2023**) ★. \[[paper](https://arxiv.org/abs/2307.01694)]\[[code](https://github.com/BICLab/Spike-Driven-Transformer) ⭐ 319 | 🐛 4 | 🌐 Python | 📅 2024-03-18]
...
* Spike-driven Transformer V2 (Meta-SpikeFormer) (**ICLR 2024**). \[[paper](https://arxiv.org/abs/2404.03663)]\[[code](https://github.com/BICLab/Spike-Driven-Transformer-V2) ⭐ 235 | 🐛 1 | 🌐 Python | 📅 2024-05-10]
...
* Attention Spiking Neural Networks (MA-SNN) (**IEEE TPAMI 2023**). \[[paper](https://arxiv.org/abs/2209.13929)]\[[code](https://github.com/BICLab/Attention-SNN) ⭐ 88 | 🐛 7 | 🌐 Python | 📅 2024-05-20]
...
* Spike2Former: Efficient Spiking Transformer for High-Performance Image Segmentation (**AAAI 2025**). \[[paper](https://arxiv.org/abs/2412.14587)]\[[code](https://github.com/BICLab/Spike2Former) ⭐ 44 | 🐛 3 | 🌐 Python | 📅 2026-01-14]
...
| Suite          | What                                                                             | Links                                                                                                                                     |
| -------------- | -------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| **NeuroBench** | Standardized tasks & metrics to fairly benchmark neuromorphic algorithms/systems | [paper](https://arxiv.org/abs/2304.04640) · [code](https://github.com/NeuroBench/neurobench) ⭐ 136 \| 🐛 10 \| 🌐 Python \| 📅 2026-05-14 |
...
| ------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| **[SpikingJelly](https://github.com/fangwei123456/spikingjelly) ⭐ 2,141 \| 🐛 125 \| 🌐 Python \| 📅 2026-09-19**   | PyTorch full-stack SNN framework (data → train → deploy), fused CUDA neurons; de-facto platform — 2.0 line (Triton kernels, FlexSN) in dev since 2026-07 | [paper](https://www.science.org/doi/10.1126/sciadv.adi1480)                                           |
| **[snnTorch](https://github.com/jeshraghian/snntorch) ⭐ 2,053 \| 🐛 58 \| 🌐 Python \| 📅 2026-09-20**              | Spiking neurons as recurrent units in PyTorch; superb tutorials — 1.0.0 stable landed 2026-06                                                            | [paper](https://arxiv.org/abs/2109.12894)                                                             |
| **[Norse](https://github.com/norse/norse) ⭐ 822 \| 🐛 67 \| 🌐 Python \| 📅 2026-07-07**                            | Sparse, event-driven bio-inspired primitives in PyTorch                                                                                                  | —                                                                                                     |
| **[BindsNET](https://github.com/BindsNET/bindsnet) ⭐ 1,701 \| 🐛 12 \| 🌐 Python \| 📅 2026-09-21**                 | ML-oriented SNN simulation on PyTorch (STDP / RL)                                                                                                        | [paper](https://www.frontiersin.org/journals/neuroinformatics/articles/10.3389/fninf.2018.00089/full) |
...
| **[ANNarchy](https://github.com/ANNarchy/ANNarchy) ⭐ 46 \| 🐛 6 \| 🌐 Python \| 📅 2026-09-21**                     | Code-generation simulator (rate + spiking) → C++/CUDA                                                                                                    | —                                                                                                     |
...
| **[Brian2](https://github.com/brian-team/brian2) ⭐ 1,234 \| 🐛 207 \| 🌐 Python \| 📅 2026-09-21**                                                                                       | Equation-based simulator with runtime code generation                     | [paper](https://elifesciences.org/articles/47314)                           |
| **[NEST](https://github.com/nest/nest-simulator) ⭐ 669 \| 🐛 223 \| 🌐 C++ \| 📅 2026-09-18**                                                                                            | Large heterogeneous spiking point-neuron nets, laptop → supercomputer     | —                                                                           |
| **[GeNN](https://github.com/genn-team/genn) ⭐ 282 \| 🐛 45 \| 🌐 C++ \| 📅 2026-08-24**                                                                                                  | GPU code-generation SNN simulator (CUDA / HIP)                            | [paper](https://www.nature.com/articles/srep18854)                          |
...
| **[BrainCog](https://github.com/BrainCog-X/Brain-Cog) ⭐ 654 \| 🐛 31 \| 🌐 Python \| 📅 2025-11-06**                                                                                     | SNN brain-inspired cognitive-intelligence engine (CAS)                    | [paper](https://arxiv.org/abs/2207.08533)                                   |
...
| **[v2e](https://github.com/SensorsINI/v2e) ⭐ 487 \| 🐛 23 \| 🌐 Python \| 📅 2026-04-13**                                                                                                       | Video frames → realistic DVS events (no camera needed)                    | [paper](https://openaccess.thecvf.com/content/CVPR2021W/EventVision/html/Hu_v2e_From_Video_Frames_to_Realistic_DVS_Events_CVPRW_2021_paper.html) |
...
| **[BICLab/Spike-Driven-Transformer](https://github.com/BICLab/Spike-Driven-Transformer) ⭐ 319 \| 🐛 4 \| 🌐 Python \| 📅 2024-03-18**                                        | Spike-driven Transformer (NeurIPS 2023)                  |  \~315 |
...
| **[BICLab/Spike-Driven-Transformer-V2](https://github.com/BICLab/Spike-Driven-Transformer-V2) ⭐ 235 \| 🐛 1 \| 🌐 Python \| 📅 2024-05-10**                                  | Meta-SpikeFormer (ICLR 2024)                             |  \~230 |
...
| Repo                                                                                                                                             | What                                        | Stars |
| ------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------- | :---: |
| **[TheBrainLab/Awesome-Spiking-Neural-Networks](https://github.com/TheBrainLab/Awesome-Spiking-Neural-Networks) ⭐ 839 \| 🐛 4 \| 📅 2026-03-24** | Broad SNN paper list (papers, code, sites)  | \~805 |
...
| **[SpiNNakerManchester/sPyNNaker](https://github.com/SpiNNakerManchester/sPyNNaker) ⭐ 120 \| 🐛 102 \| 🌐 Python \| 📅 2026-09-22** | PyNN on the million-core SpiNNaker machine          | \~117 |
...
* **Tian Yonghong (田永鸿)** — Peking University — neuromorphic vision, spike camera, SpikingJelly. \[[homepage](https://www.pkuml.org/staff/yhtian.html)]\[[scholar](https://scholar.google.com/citations?user=fn6hJx0AAAAJ)]\[[github](https://github.com/fangwei123456/spikingjelly) ⭐ 2,141 | 🐛 125 | 🌐 Python | 📅 2026-09-19]
...
* **Yu Zhaofei (余肇飞)** — Peking University — SNN learning, neural coding, SpikingJelly. \[[homepage](https://www.ai.pku.edu.cn/en/info/1459/2031.htm)]\[[scholar](https://scholar.google.com/citations?user=qaUgD50AAAAJ)]\[[github](https://github.com/fangwei123456/spikingjelly) ⭐ 2,141 | 🐛 125 | 🌐 Python | 📅 2026-09-19]
...
* **Zeng Yi (曾毅)** — Institute of Automation, CAS (CASIA) — brain-inspired cognitive intelligence, brain simulation, AI ethics. \[[homepage](https://www.brain-cog.network/)]\[[github](https://github.com/BrainCog-X/Brain-Cog) ⭐ 654 | 🐛 31 | 🌐 Python | 📅 2025-11-06]
...
* **Jason Eshraghian** — UC Santa Cruz (Neuromorphic Computing Group) — snnTorch, spiking LLMs, memristive hardware. \[[homepage](https://ncg.ucsc.edu/)]\[[github](https://github.com/jeshraghian/snntorch) ⭐ 2,053 | 🐛 58 | 🌐 Python | 📅 2026-09-20]
...
* **Thomas Nowotny** — University of Sussex — GPU-accelerated SNN simulation. \[[homepage](https://profiles.sussex.ac.uk/p206151-thomas-nowotny)]\[[github](https://github.com/genn-team/genn) ⭐ 282 | 🐛 45 | 🌐 C++ | 📅 2026-08-24]
...
* **Tobi Delbruck** — Institute of Neuroinformatics, UZH & ETH Zurich — event cameras (DVS), event-driven vision. \[[homepage](https://sensors.ini.ch/people/tobi-delbruck)]\[[github](https://github.com/SensorsINI/jaer) ⭐ 202 | 🐛 1 | 🌐 Java | 📅 2026-09-22]
